...
**F4'te bu oturumda hâlâ açık kalan maddeler (dürüst değerlendirme):**
- **Isolated worker bootstrap**: gerçek copy-on-write overlay yok (yukarıdaki tasarım kararına bkz.).
- **OS izolasyonu**: seccomp filtresi hâlâ yapılmadı (yanlış yazılmış bir filtre üretimde `git apply`'i sessizce kırabilir, bu ortamda uçtan uca doğrulanamaz — bilinçli olarak ertelendi).
