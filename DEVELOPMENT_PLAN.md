...
- [x] Pasif keşif — sertifika şeffaflık (Certificate Transparency) kayıtlarından subdomain bulma (kalan alt maddeler açık: teknoloji parmak izi, geçmiş URL/endpoint kayıtları).
